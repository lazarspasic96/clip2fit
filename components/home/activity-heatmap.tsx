  ...
  return (
    <View className="mx-5 gap-3">
      ...
      <View className="flex-row items-center justify-between">
        <Text className="text-sm font-inter-semibold text-content-primary">Activity</Text>
        {totalSessions > 0 ? (
      ...
      {days.length === 0 ? (
        <View className="bg-background-tertiary rounded-2xl p-6 items-center justify-center">
          <Text className="text-sm font-inter text-content-tertiary">No activity yet</Text>
        </View>
      ) : (
