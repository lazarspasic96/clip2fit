...
export const TikTokIcon = ({ size = 20 }: PlatformIconProps) => (
...
export const InstagramIcon = ({ size = 20 }: PlatformIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const YouTubeIcon = ({ size = 20 }: PlatformIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const XIcon = ({ size = 18 }: PlatformIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
export const FacebookIcon = ({ size = 20 }: PlatformIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
